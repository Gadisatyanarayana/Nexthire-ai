...
- Name: coding-workspace.spec.ts >> Phase 3 Step 1: Coding Workspace & Problem Player >> Mock submission works
- Location: tests\e2e\coding-workspace.spec.ts:47:7
...
Locator: locator('button:has-text("Submit")')
Expected: enabled
Timeout: 5000ms
