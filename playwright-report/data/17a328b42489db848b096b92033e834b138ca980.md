...
- Name: aptitude.spec.ts >> Aptitude Core Flow E2E Parity >> Module progression and Lesson locking works
- Location: tests\e2e\aptitude.spec.ts:26:7
...
Locator: locator('a[href^="/aptitude/learn/"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href^="/aptitude/learn/"]').first()
