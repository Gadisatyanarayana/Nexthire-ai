...
- Name: coding-workspace.spec.ts >> Phase 3 Step 1: Coding Workspace & Problem Player >> Mock run execution works
- Location: tests\e2e\coding-workspace.spec.ts:36:7
...
Locator: locator('button:has-text("Run Code")')
Expected: enabled
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Run Code")')
