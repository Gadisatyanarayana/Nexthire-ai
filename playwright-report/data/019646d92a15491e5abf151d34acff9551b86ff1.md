...
- Name: aptitude.spec.ts >> Aptitude Core Flow E2E Parity >> Mock Test Engine generates different tests
- Location: tests\e2e\aptitude.spec.ts:56:7
...
Locator: getByRole('heading', { name: /Mock Assessments|Something went wrong/i })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Mock Assessments|Something went wrong/i })
