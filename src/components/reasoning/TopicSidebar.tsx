...
import { ReasoningModule, ReasoningLesson } from "@/models/reasoning";
...
export function TopicSidebar({ 
  ...
  modules: (ReasoningModule & { reasoning_lessons: ReasoningLesson[] })[],
      ...
      <div className="p-6">
        ...
        <div className="space-y-8">
          {modules.map((module, mIdx) => {
            const allLessons = modules.flatMap(m => m.reasoning_lessons || []);
            ...
            <div key={module.id} className={`space-y-3 ${isModuleLocked ? 'opacity-50' : ''}`}>
              ...
              <div className="space-y-1">
                {module.reasoning_lessons?.map((lesson, lIdx) => {
                  ...
                  return isLocked ? (
                    ...
                    <Link
                      key={lesson.id}
                      href={`/reasoning/learn/${module.id}/${lesson.id}`}
                      className={`
