...
export function DailyCoachingCard() {
  ...
  useEffect(() => {
    async function loadPlan() {
      try {
        const res = await fetch("/api/v1/reasoning/ai/coach");
    ...
    <div className="bg-gradient-to-br from-emerald-500/10 to-transparent border border-emerald-500/20 rounded-2xl p-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="flex gap-4">
          <Link href={plan.recommendedRoute || "/reasoning"} className="px-4 py-2 bg-emerald-500 text-black font-bold text-sm rounded-lg hover:bg-emerald-400 transition flex items-center gap-2">
