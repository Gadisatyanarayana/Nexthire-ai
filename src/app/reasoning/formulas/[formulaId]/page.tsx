...
import { getFormula } from "@/lib/api/reasoningV2";
import { FormulaViewer } from "@/components/reasoning/FormulaViewer";
  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="max-w-4xl mx-auto px-4 py-12 md:px-8">
        <Link href={`/reasoning/learn/${formula.topic_id}`} className="text-zinc-400 hover:text-white flex items-center gap-2 mb-8 text-sm">
