...
import { getLesson, getModule, getFormulasByLesson, getQuestionPreview, getModules, getServerUserId, getUserTopicMastery } from "@/lib/api/reasoningV2";
import { TopicSidebar } from "@/components/reasoning/TopicSidebar";
import { LessonViewer } from "@/components/reasoning/LessonViewer";
  ...
  return (
    <div className="min-h-screen bg-black flex">
      <main className="flex-1 overflow-y-auto">
        {locked ? (
          redirect(`/reasoning/learn/${resolvedParams.moduleId}`)
        ) : (
          <LessonViewer 
