...
import { getModule, getLessonsByModule, getModules, getAllLessons, getServerUserId, getUserTopicMastery } from "@/lib/api/reasoningV2";
...
export default async function ModulePage({ params }: { params: Promise<{ moduleId: string }> }) {
  ...
  const sidebarModules = allModules.map(m => ({
    ...m,
    reasoning_lessons: m.id === moduleData.id ? lessons : []
  }));
