...
- Name: aptitude.spec.ts >> Aptitude Core Flow E2E Parity >> Adaptive Practice Flow
- Location: tests\e2e\aptitude.spec.ts:44:7
...
Locator: getByText(/Question 1 of/i).or(getByText(/No adaptive questions available|Loading|Something went wrong/i))
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText(/Question 1 of/i).or(getByText(/No adaptive questions available|Loading|Something went wrong/i))
